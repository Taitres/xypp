...
import com.taitres.xypp.model.enums.TeamStatusEnum;
...
import com.taitres.xypp.model.vo.UserVO;
import com.taitres.xypp.service.TeamService;
import com.taitres.xypp.mapper.TeamMapper;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public boolean joinTeam(TeamJoinRequest teamJoinRequest, User loginUser) {
        ...
        // 只有一个线程能获取到锁
        RLock lock = redissonClient.getLock(String.format("%s:join_team", SYSTEM_ID));
        try {
            // 抢到锁并执行
            while (true) {
